...
<button onclick="window.location.href='/alunos'" class="btn btn-primary"><span class="glyphicon glyphicon-circle-arrow-left"></span> Voltar</button>
    ...
    <form method="POST" action="/alunos/{{$aluno->id}}/editar">
        ...
        <div class="form-group col-md-3">
          ...
          <input type="text" onblur="pesquisacep(this.value);" name="cep" class="form-control" id="cep" value="{{$aluno->endereco->CEP}}">
        </div>
        <div class="form-group col-md-3">
          <label for="bairro">BAIRRO</label>
          <input type="text" class="form-control" name="bairro" id="bairro" value="{{$aluno->endereco->bairro}}">
        </div>
        <div class="col-md-12">
          <div class="col-md-6">
            @if ($errors->has('nome'))
        ...
        <div class="form-group col-md-2">
          ...
          <input type="number" class="form-control" name="numero" id="numero" value="{{$aluno->endereco->numero}}">
        </div>
        <div class="form-group col-md-3">
          <label for="cidade">CIDADE</label>
          <input type="text" class="form-control" name="cidade" id="cidade" value="{{$aluno->endereco->cidade}}">
        </div>
        <div class="form-group col-md-1">
          <label for="estado">ESTADO</label>
          <input type="text" class="form-control" id="estado" name="estado" value="{{$aluno->endereco->uf}}" maxlength=2>
        </div>
        <div class="col-md-12">
          <div class="col-md-6">
            @if ($errors->has('rua'))
